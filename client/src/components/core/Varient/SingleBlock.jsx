...
const SingleBlock = ({ list, name }) => {
    ...
    const [option, setOption] = useState('Cold Rolled');
    ...
    return (
        <div className={style.Varient}>
            ...
            <form style={{ height: showForm ? '40px' : '0' }} onSubmit={(e) => onSubmit(e, name)}>
                ...
                <input type='text' value={varient} onChange={(e) => setVarient(e.target.value)} placeholder={`Name of ${name}`} style={{ width: '100%' }} autoFocus />
                <div>
